...
public class DHDemoView extends VisualizationView {
	...
	public DHDemoView() {
		...
		this.aliceExplain.setText("<html><div style=\"width:650px; height:100px\">" + explanation1 + "</div></html>");
		gbc.weightx = 0.1;
		gbc.weighty = 0.1;
		gbc.gridx = 1;
		gbc.gridy = 2;
	...
	private void secondStep() {
		aliceExplain.setText("<html><div style=\"width:650px; height:100px\">" + explanation2 + "</div></html>");
	...
	private void fourthStep() {
		aliceExplain.setText("<html><div style=\"width:650px; height:100px\">" + explanation3 + "</div></html>");
	...
	private void sixthStep() {
		aliceExplain.setText("<html><div style=\"width:650px; height:100px\">" + explanation4 + "</div></html>");
