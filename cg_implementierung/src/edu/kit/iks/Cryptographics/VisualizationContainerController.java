...
public class VisualizationContainerController extends AbstractController {
	...
	public VisualizationContainerController(AbstractVisualizationInfo visualizationInfo) {
		...
		List<Class> childClasses = this.visualizationInfo.getControllerClasses();
		
		// Create an array that can hold all visualization controllers.
		// The controller's will be instantiated on demand (lazily).
		this.visualizationControllers = new AbstractVisualizationController[childClasses.size()];
	}
	...
	public void setCurrentVisualizationControllerIndex(int index) {
		AbstractVisualizationController oldController = this.getCurrentVisualizationController();
	...
	public boolean hasNextVisualizationController() {
		return (this.currentVisualizationControllerIndex < this.visualizationInfo.getControllerClasses().size() - 1);
	}
