...
public class FirstDemonstrationView extends VisualizationView{
	...
	private void setupGUI(VigenereVisualizationInfo visualizationInfo) {
		...
		this.moduloText = new JLabel("<html><div width=\"1200\">" + 
				...
				+ "clock uses a modulo of 12, because we have only 12 steps in it. If we overflow, we start from the beginnig. The same system will now be used with the alphabet (which has 26 characters) to create Vigen�re's cipher...")
				+ "</div></html>");
