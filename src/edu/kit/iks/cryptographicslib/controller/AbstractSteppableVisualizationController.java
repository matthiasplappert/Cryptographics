 ...
 *
 */
public abstract class AbstractSteppableVisualizationController extends
	...
	/**
	 * Pressing the 'Step' button will load the next partial view as defined in the
	 * defineRunningOrder() method. If the last partial view is being displayed, and 'Step'
	 * is pressed, the next controller will be loaded.
	 */
	protected void useDefaultStepButtonBehavior() {
		...
		((AbstractVisualizationView) this.view).setStepButtonActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				AbstractSteppableVisualizationController.this.presentNextStep();
			}
