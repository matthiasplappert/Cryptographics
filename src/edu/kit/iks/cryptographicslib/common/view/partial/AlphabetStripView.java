...
public class AlphabetStripView extends JPanel {
	...
	private static final Border normalBorder = BorderFactory
			.createEtchedBorder(EtchedBorder.RAISED, Color.lightGray, Color.gray);
	private static final Border highlightBorder = BorderFactory
			.createEtchedBorder(EtchedBorder.LOWERED, Color.lightGray.darker(), Color.gray.darker());
