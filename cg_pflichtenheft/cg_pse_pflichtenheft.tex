...
\begin{PD}[start=10]
  \item Für einen Logeintrag zur externen Analyse von Nutzerverhalten sind folgende Daten zu speicher:
  \begin{itemize}
    \item Zeitstempel
    \item zugehörige Visualisierung
    \item Ereignis-Code
    \item Frei wählbare textliche Beschreibung des Ereignisses
  \end{itemize}
\end{PD}
