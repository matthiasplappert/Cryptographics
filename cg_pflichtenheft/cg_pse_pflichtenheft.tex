...
//Todo: Didn't we decide to kick PKI and some other stuff out?
\begin{FA}[start=500]
...
\begin{NA}[start=100]
\item Verhätlnismäßig zur Hardware soll Cryptographics möglichst performant und verzögerungsfrei auf Benutzereingaben reagieren.
\end{NA}
...
//TODO: Meiner Meinung nach sollte jeder zu den funktionalen Anforderungen, 
die er geschrieben hat noch Testfälle oder Testszenarien sich überlegen.
Dies kommt aschnließend auch in Globale Testfälle rein. Je mehr Testfälle wir uns jetzt überlegen. 
Desto einfacher wird es später, da mit dem Pflichtenheft wir die Funktionalität bereits festgelegt haben.
Für Stabilität können wir in der Phase wenig tun.
\begin{T}[start = 10]
...
In diesem Kapitel wird den Qualitätsmerkmalen Funktionalität, Zuverlässigkeit, Benutzbarkeit, Effizienz, Änderbarkeit
und Übertragbarkeit je eine Qualitätsstufe aus sehr gut, gut, normal und nicht relevant zugeordnet. 
\end{document}
