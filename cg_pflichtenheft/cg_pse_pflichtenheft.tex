...
%/Ceasar Visualiserung, Funktionale Anforderungen.
\begin{FA}[start=100]
 \item Prozess: Visualiserung des Verfahrens Ceasar.
\end{FA}
\begin{itemize}[label={}]
...
\end{enumerate}
 ...
 \item Phase 3: Wiki.
  \begin{enumerate}
   \item Sammlung an Artikeln über das Verfahren Ceasar.
  ...
  \end{enumerate}
\end{itemize}
%/ Ende der Funktionalen Anforderungen für Caesar.
...
\begin{itemize}[label={}]
 ...
 \end{enumerate}
 \item Phase 3: Wiki.
 \item Identisch mit den funktionalen Anforderungen aus Ceasar, Phase 3: Wiki.
\end{itemize}
...
\begin{enumerate}
 \item[1-4] Die ersten 4 funktionalen Anforderungen sind identisch mit den Anforderungen aus Ceasar und Vigenere. 
...
\item Phase 3: Wiki.
\begin{enumerate}
 \item[1-2] Identisch mit den funktionalen Anforderung aus Ceasar und Vigenere
\end{enumerate}.
\end{itemize}
...
\begin{enumerate}
 \item[1-5] Die funktionalen Anforderungen and diese Phase sind identisch mit den 
            funktionalen Anforderung in Ceasar, Vigenere und PKI.
\end{enumerate}
