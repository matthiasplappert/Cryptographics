...
text here
  % They divide it like this on their table of contents,
  % but since we only have jUnit test cases, this might be 
  % senseless?
 ...
 \subsection{Caesar}
  \begin{enumerate}
   \item Leider konnte die UI nicht überall statisch gemacht werden. Beispielsweise bei der Demonstration der Caesar-Chiffre 
         ...
         1. Experiment: Beim Ent- und Verschlüsseln sollte alles statisch an seinem Ort bleiben und sich nichts bewegen.\newline
