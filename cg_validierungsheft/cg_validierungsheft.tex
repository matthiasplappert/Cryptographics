 ...
 \subsection{Caesar}
  \begin{enumerate}
   \item \textbf{Regressionstests für springende UI:}\newline
         ...
         1. Demonstration: Bei der Demonstrierung der Chiffre sollte vor allem bei der Abwechslung vom ``weiter'' Button und 
            der Tastatur darauf geachtet werden, dass die UI statisch bleibt.
         2. Experiment: Beim Ent- und Verschlüsseln sollte alles statisch an seinem Ort bleiben und sich nichts bewegen.\newline
         3. Histogramme: Achte vor allem bei der Auswahl der Eingabebox für den Schlüssel, ob alles an seinem Ort bleibt, wenn die
            Tastatur erscheint.
